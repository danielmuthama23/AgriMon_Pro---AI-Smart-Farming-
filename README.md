...
> Built with React · Claude AI · Hedera Hashgraph · MCP · YOLOv8 Computer Vision
...
AgriSmart Pro consolidates drone camera feeds, soil sensors, weather history, livestock data, and farm finances into a single dashboard. It uses Claude AI for agronomic advice, YOLOv8 for real-time intruder and animal detection, and Hedera Hashgraph for tamper-proof transaction and incident records.
...
AgriSmart Pro uses Hedera Hashgraph for three purposes:
